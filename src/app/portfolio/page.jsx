            ...
            <div className={styles.PortfolioContainer1}>
              ...
              <div className={styles.modaleBG}>
                ...
                <div className={styles.modaleDesc}>
                    ...
                    <a target="_blank" href={projet[CurrentIndex].github} className={styles.ModaleLink} rel="noopener noreferrer">
                            <Image src={logoGH} alt="" width={20} height={20}/>
                            <span>  LIEN GITHUB</span>
                        </a>
                        <a target="_blank" href={projet[CurrentIndex].lien} className={styles.ModaleLink} rel="noopener noreferrer">DECOUVRIR L&apos;APP WEB</a>
                    </div>
                </div>
            </div> 
            </section>
